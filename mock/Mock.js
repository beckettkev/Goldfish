//Object.keys(action.data.payload[9].Cells).map(function(item) { return item + ': ' + action.data.payload[8].Cells[item]; }).join(', ');

/*

The follow mock data is for testing purposes. It is not real.

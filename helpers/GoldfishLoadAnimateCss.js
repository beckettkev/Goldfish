/*
	This helper script will allow you to invoke Goldfish with Animate CSS.
...
function begin() {
	addHeadResource('https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.1/animate.min.css', 'css', Goldfish.Create);
}
...
(function() {
	...
	if (ua.indexOf('MSIE ') > -1 || ua.indexOf('Trident/') > -1 || ua.indexOf('Edge/') > -1) {
		//IE Pollyfill
		addHeadResource('https://cdnjs.cloudflare.com/ajax/libs/babel-core/5.6.15/browser-polyfill.min.js', 'js', begin);
	} else {
		//not in ie
		begin();
	}
